...
Main:
	...
	tst	enable_anim_chessboard_flag
	beq.s	do_other
	bsr.w	draw_chessboard
do_other
...
draw_chessboard:
	...
	moveq	#0,d0
	move.w	chessboard_anim_cnt, d0
	subq	#1, d0
	tst	d0
	bne.s	exit_noop_draw_chessboard
...
draw_cb_loop_alt:
	...
	bne.s	not_zero
	neg	chessboard_flag
	clr.w 	enable_anim_chessboard_flag
	bra.s	exit_draw_chessboard
not_zero:
	btst	#3, d1
	beq.w	exit_draw_chessboard
	neg	chessboard_flag
	clr.w	enable_anim_chessboard_flag
exit_draw_chessboard:
	sub.b	chessboard_flag, d1
	move.b	d1, chessboard_counter
	move.w	#CHESSBOARD_ANIM_SPEED, d0
exit_noop_draw_chessboard:
	move.w	d0, chessboard_anim_cnt
	rts
...
check_bottom_1:
	...
	st	enable_anim_chessboard_flag
check_bottom_2:
	lea	TABY+280, a0
	cmp.l	a0, d1
...
enable_anim_chessboard_flag:	dc.w	0
